    ...
    try:
        if action == "create_prompt":
            ...
            if not ref_audio or not ref_text:
                return {"error": "action 'create_prompt' requires both 'ref_audio' and 'ref_text'"}
            ...
            if voice_clone_prompt_base64:
                ...
                return {"error": "Generation requires 'ref_audio'/'ref_text' OR a 'voice_clone_prompt'"}
            ...
            for wav in wavs:
                ...
                audios_base64.append(base64.b64encode(buffer.getvalue()).decode('utf-8'))
